...
- не терять микро-практики, named concepts, авторские метафоры, чек-листы, ритуалы, инструменты и практические императивы только потому, что они вложены в крупный framework;
...
- micro-practice inventory: named concepts, авторские метафоры, чек-листы, ритуалы, инструменты, practical imperative phrases and nested actionable subheadings;
...
- **Micro-practices** — named concepts, приемы, ритуалы, чек-листы, инструменты, практические императивы и вложенные подзаголовки, которые можно применить отдельно;
- **Anti-patterns** — чего избегать и почему;
...
- **лайфхаки, приемы и инструменты к внедрению** — отдельный раздел в главном файле сразу после быстрой карты; пункты извлекаются из всей книги и оформляются как прикладные карточки `Что внедрить`, `Контекст`, `Когда применять`, `Первый шаг`, `Источник / где искать в книге`; `Контекст` кратко передает конкретную source-backed сцену, кейс, мысленный эксперимент или причинную демонстрацию из книги: ситуацию и участников, действие/решение и эффект, не повторяя идею и не выдумывая отсутствующие детали;
...
- **micro-practice coverage gate** — каждый source-derived micro-practice candidate получает статус `card | folded_into | excluded_with_reason`; термин, прием или практический императив из source не может молча исчезнуть;
...
- каждый пункт пишется не цитатой, а прикладной карточкой: `Что внедрить`, `Контекст`, `Когда применять`, `Первый шаг`, `Источник / где искать в книге`;
- `Контекст` — сжатый source-backed summary конкретной сцены, кейса, мысленного эксперимента или причинной демонстрации: кто/в какой ситуации действовал, что сделал или решил и какой эффект получил; он не повторяет `Что внедрить`, не подменяется generic advice, не выдумывает отсутствующих людей/компании/результаты и не воспроизводит большой фрагмент source;
...
- Toolkit проходит micro-practice coverage: каждый named concept, авторская метафора, чек-лист, ритуал, инструмент, practical imperative или вложенный actionable subheading из source имеет статус `card | folded_into | excluded_with_reason`.
