...
- Books toolkit output должен строиться вокруг reusable элементов: модели, принципы, техники, anti-patterns, сценарии применения, шпаргалки, glossary, patterns / techniques and topic index.
