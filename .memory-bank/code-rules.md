...
- Books v1 runtime утверждён 2026-05-07 как local CLI contour on Node/npm orchestration with optional Python extraction adapter. Product source должен жить под `src/books/`; generated local artifacts — под ignored `runtime/books/`.
