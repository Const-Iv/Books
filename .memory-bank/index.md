...
- Mission, vision, goal, аудитория, project-level `JTBD` и User Stories — в `product-charter.md` или Project Intake. Task-планы используют цель, контекст, одну Job Story, входные данные, ожидаемый результат, критерии приемки, проверку, ограничения и применимый `Eval spec`.
