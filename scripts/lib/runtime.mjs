 ...
 * @property {"parallel_duplicate_commit"|null} [equivalenceMode]
 * @property {string | null} [replacementCommitSha]
 * @property {string | null} [equivalenceVerifiedAt]
 * @property {string | null} [equivalenceMainSha]
 * @property {"passed"|"failed"|null} [duplicateAcceptanceStatus]
 * @property {string | null} [duplicateAcceptanceMainSha]
 * @property {string | null} [duplicateAcceptanceAt]
 * @property {string | null} [duplicateAcceptanceCommand]
 * @property {"declared_successor_lineage"|null} [supersessionMode]
 * @property {"superseded_verified"|null} [supersessionStatus]
 * @property {1|2|null} [supersessionManifestVersion]
 * @property {string | null} [supersessionManifestSha256]
 * @property {string | null} [supersessionManifestRelativePath]
 * @property {string | null} [supersessionProofArtifactRelativePath]
 * @property {Array<{mainSha: string, manifestSha256: string, manifestRelativePath: string, verifiedAt: string | null, artifactRelativePath: string}>} [supersessionProofHistory]
 * @property {string | null} [supersessionVerifiedAt]
 * @property {string | null} [supersessionMainSha]
 * @property {Array<
 *   {taskId: string, commitSha: string, paths: string[]} |
 *   {kind: "managed_task", taskId: string, commitSha: string, paths: string[]} |
 *   {kind: "approved_direct_main", commitSha: string, paths: string[], changedPaths: string[]}
 * >} [successorLineage]
 * @property {"passed"|"failed"|null} [originalAcceptanceStatus]
 * @property {string | null} [originalAcceptanceTaskSha]
 * @property {string | null} [originalAcceptanceAt]
 * @property {string | null} [originalAcceptanceCommand]
 * @property {"passed"|"failed"|null} [successorAcceptanceStatus]
 * @property {string | null} [successorAcceptanceMainSha]
 * @property {string | null} [successorAcceptanceAt]
 * @property {string | null} [successorAcceptanceCommand]
 ...
 * @property {"legacy_state_reconciled"|null} [legacyReconciliationStatus]
 * @property {string | null} [legacyReconciliationManifestSha256]
 * @property {string | null} [legacyReconciliationManifestRelativePath]
 * @property {string | null} [legacyReconciliationProofArtifactRelativePath]
 * @property {string | null} [legacyReconciliationAt]
 * @property {string | null} [legacyReconciliationMainSha]
 * @property {string | null} [legacyReconciliationPublishVerifiedMainSha]
 * @property {string | null} [legacyReconciliationOriginalPublishStatus]
 * @property {string[]} [legacyReconciliationFields]
